...
class AppColors {
  ...
  static const primarySwatchColor = MaterialColor(0xFF9C231B, {
    50: Color.fromRGBO(156, 35, 27, .1),
    100: Color.fromRGBO(156, 35, 27, .2),
    200: Color.fromRGBO(156, 35, 27, .3),
    300: Color.fromRGBO(156, 35, 27, .4),
    400: Color.fromRGBO(156, 35, 27, .5),
    500: Color.fromRGBO(156, 35, 27, .6),
    600: Color.fromRGBO(156, 35, 27, .7),
    700: Color.fromRGBO(156, 35, 27, .8),
    800: Color.fromRGBO(156, 35, 27, .9),
    900: Color.fromRGBO(156, 35, 27, 1),
  });

  //Primary Color
  static const primaryLightest = Color(0XFF9C231B);
  static const primaryLight = Color(0XFFE0E8FA);
  static const primary = Color(0XFF33374c);
